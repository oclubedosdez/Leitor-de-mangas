...
for (let i = 1; i <= 53; i++) { // Adicionando 5 capítulos com base na data atual
...
<span class='nome_alt'>공작의 99번째 신부</span>
`
...
var autor_da_obra = '<span>Autor: </span> <p>Lisabel</p>';
var artista_da_obra = '<span>Artista: </span> <p>ALLYN</p>';
