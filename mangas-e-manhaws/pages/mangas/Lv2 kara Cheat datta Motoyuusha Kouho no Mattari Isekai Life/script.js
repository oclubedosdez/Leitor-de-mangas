...
var nome = 'Lv2 kara Cheat datta Moto Yuusha Kouho no Mattari Isekai Life'; //nome do manga/manhwa
...
<span class='nome_alt'>Candidate was a Cheat from Lv2</span>
<span class='nome_alt'>Chillin Different World Life of the Ex-Brave Candidate was Cheat from Lv2</span>
<span class='nome_alt'>LV2からチートだった元勇者候補のまったり異世界ライフ</span>
`

var tipo = 'manga' // é manga ou manhwa

//CAMINHO DA IMAGEM
var caminho = 'https://raw.githubusercontent.com/oclubedosdez/Imagens/main/mangas/img/Lv2 kara Cheat datta Moto Yuusha Kouho no Mattari Isekai Life.jpg';
...
var autor_da_obra = '<span>Autor(es): </span> <p>KINOJO Miya</p>';
var artista_da_obra = '<span>Artista(es): </span> <p>ITOMACHI Akine</p>';
var estatus_obra = '<span>Status: </span> <p>Ativo</p>';

var sinopese_da_obra = '<strong>Sinopse:</strong>Banaza foi invocado ao reino mágico de Cryroad como candidato a herói. No entanto, por ter especificações como as de uma pessoa comum, ele foi desqualificado e não pôde voltar ao seu mundo devido a um erro das pessoas que o invocaram. Sendo apenas nível 2, Banaza obterá forças além de sua compreensão.';
